...
- Parameter: n (any) number of values (number, string, boolean, array, null, undefined, object and function etc)
   ...
   - Example:
     ...
     colors.concat('black', 'red', 21, true); // ['red','green','blue','black', 'red', 21, true]
     ```
   - `push` accepts n number of values and returns one array with all the values in same order. It does not change the original array.
   - No it does not mutate the original array
...
- Parameter: n (any) number of values (number, string, boolean, array, null, undefined, object and function etc)
   ...
   - Example:
     ...
     colors.concat('black', 'red', 21, true); // ['red','green','blue','black', 'red', 21, true]
     ```
   - `indexof` accepts n number of values and returns one array with all the values in same order. It does not change the original array.
   - No it does not mutate the original array
...
- Parameter: n (any) number of values (number, string, boolean, array, null, undefined, object and function etc)
   ...
   - Example:
     ...
     colors.concat('black', 'red', 21, true); // ['red','green','blue','black', 'red', 21, true]
     ```
   - `lastIndexof` accepts n number of values and returns one array with all the values in same order. It does not change the original array.
   - No it does not mutate the original array
...
- Parameter: n (any) number of values (number, string, boolean, array, null, undefined, object and function etc)
   ...
   - Example:
     ...
     colors.concat('black', 'red', 21, true); // ['red','green','blue','black', 'red', 21, true]
     ```
   - `includes` accepts n number of values and returns one array with all the values in same order. It does not change the original array.
   - No it does not mutate the original array
...
- Parameter: n (any) number of values (number, string, boolean, array, null, undefined, object and function etc)
   ...
   - Example:
     ...
     colors.concat('black', 'red', 21, true); // ['red','green','blue','black', 'red', 21, true]
     ```
   - `reverse` accepts n number of values and returns one array with all the values in same order. It does not change the original array.
   - No it does not mutate the original array
...
- Parameter: n (any) number of values (number, string, boolean, array, null, undefined, object and function etc)
   ...
   - Example:
     ...
     colors.concat('black', 'red', 21, true); // ['red','green','blue','black', 'red', 21, true]
     ```
   - `every` accepts n number of values and returns one array with all the values in same order. It does not change the original array.
   - No it does not mutate the original array
...
- Parameter: n (any) number of values (number, string, boolean, array, null, undefined, object and function etc)
   ...
   - Example:
     ...
     colors.concat('black', 'red', 21, true); // ['red','green','blue','black', 'red', 21, true]
     ```
   - `shift` accepts n number of values and returns one array with all the values in same order. It does not change the original array.
   - No it does not mutate the original array
...
- Parameter: n (any) number of values (number, string, boolean, array, null, undefined, object and function etc)
   ...
   - Example:
     ...
     colors.concat('black', 'red', 21, true); // ['red','green','blue','black', 'red', 21, true]
     ```
   - `splice` accepts n number of values and returns one array with all the values in same order. It does not change the original array.
   - No it does not mutate the original array
...
- Parameter: n (any) number of values (number, string, boolean, array, null, undefined, object and function etc)
   ...
   - Example:
     ...
     colors.concat('black', 'red', 21, true); // ['red','green','blue','black', 'red', 21, true]
     ```
   - `unshift` accepts n number of values and returns one array with all the values in same order. It does not change the original array.
   - No it does not mutate the original array
...
- Parameter: n (any) number of values (number, string, boolean, array, null, undefined, object and function etc)
   ...
   - Example:
     ...
     colors.concat('black', 'red', 21, true); // ['red','green','blue','black', 'red', 21, true]
     ```
   - `findIndex` accepts n number of values and returns one array with all the values in same order. It does not change the original array.
   - No it does not mutate the original array
...
- Parameter: n (any) number of values (number, string, boolean, array, null, undefined, object and function etc)
   ...
   - Example:
     ...
     colors.concat('black', 'red', 21, true); // ['red','green','blue','black', 'red', 21, true]
     ```
   - `filter` accepts n number of values and returns one array with all the values in same order. It does not change the original array.
   - No it does not mutate the original array
